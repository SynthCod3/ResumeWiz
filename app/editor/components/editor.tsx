...
export function Editor() {
  return (
    <ResizablePanelGroup
      ...
      className="w-full max-w-90 px-4 mx-auto lg:grid lg:gap-4 lg:px-6 lg:grid-cols-2"
    >
        ...
        <div className="flex items-center justify-center p-4 lg:p-10">
          <div className="grid max-w-sm gap-4 lg:max-w-md">
            ...
            <div>
              ...
              <p className="text-sm">
                Creative and detail-oriented software engineer with a passion
                for developing innovative web applications. Experienced in
                full-stack development and dedicated to writing clean and
                efficient code.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm">
                ...
                <br />- Led the development of a cutting-edge e-commerce
                platform
